...
const Landing = () => {
  ...
  const fetchServices = async () => {
    try {
      const response: AxiosResponse = await axios.get('https://hour-booking-back.vercel.app/catalogue');
    ...
    const fetchAvailableHours = async () => {
      try {
        if (date) {
          ...
          const response = await axios.get('https://hour-booking-back.vercel.app/appointments/time-slots', {
            params: {
              date: formattedDate,
  ...
  const handleFormSubmitAfterLogin = async () => {
    if (date) {
      ...
      try {
        await axios.post('https://hour-booking-back.vercel.app/appointments', {
          selectedService,
          date: formattedDate,
          time,
          customerName,
